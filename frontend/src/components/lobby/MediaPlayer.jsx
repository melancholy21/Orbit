              ...
              <div className="flex flex-col items-center">
                {getSpotifyTrackUrl(currentSpotifyTrack, currentTrack) ? (
                  <a
                    ...
                    className="hover:underline hover:text-[#1DB954] transition-colors flex items-center justify-center gap-1.5 text-lg font-bold text-foreground line-clamp-1"
                  >
          ...
          <div className="flex-1 min-w-0 pr-2">
            {getSpotifyTrackUrl(currentSpotifyTrack, currentTrack) ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline hover:text-[#1DB954] transition-colors flex items-center gap-1.5 text-sm font-semibold text-foreground truncate"
              >
